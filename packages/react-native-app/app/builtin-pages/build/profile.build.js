...
function imgWithFallbacks (baseSrc, exts, {cls} = {}) {
  var el = render$4(baseSrc, exts, cls);
  return el
}

function render$4 (baseSrc, exts, cls) {
...
function onerror (e, baseSrc, exts, cls) {
  if (exts.length > 0) {
    yo.update(e.target, render$4(baseSrc, exts, cls));
  }
}
