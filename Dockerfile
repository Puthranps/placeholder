...
# Maintainer
MAINTAINER Preethesh Puthran <pputhran@masonlive.gmu.edu>
...
ENV ANDROID_BUILD_TOOLS_VERSION build-tools-25.0.3,build-tools-25.0.2,build-tools-25.0.1,build-tools-23.0.2,build-tools-23.0.3,build-tools-23.0.1
